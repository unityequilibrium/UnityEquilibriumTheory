...
MAJOR_RESULT_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "source_and_uncertainty": {
        ...
        "required_subresults": [
            ...
            {"subresult_id": "heating_backcalculation_no_go", "label": "Incident-heating C_src back-calculation no-go", "current_status": "CLOSED_AS_NO_GO", "evidence_result_ids": ["T13_DING_C_SRC_HEATING_BACKCALCULATION_IDENTIFIABILITY"], "required_closure_level": "CLOSED_AS_NO_GO", "acceptance": "Incident fluence, a temperature upper bound, and normalized TTG rows are shown not to identify absolute C_src without absorbed-energy and absolute-response inputs."},
