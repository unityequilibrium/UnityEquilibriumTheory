"""Synchronize the Topic 13 subtracted sunset-dispersion lane record."""
...
LANE_REL = "docs/core/07_artifacts/topic13/t13_uet_o2_sunset_dispersion_interface_audit.json"
DEPENDENCY_REL = "docs/core/07_artifacts/gates/uet_major_result_dependency_unlock_gate.json"
LANE_ID = "T13_UET_O2_SUBTRACTED_SUNSET_DISPERSION_INTERFACE_LANE"
    ...
    record["evidence_artifacts"].append(
        {
            ...
            "sha256": full_hash,
            "summary": {
                "projection": "Topic 13 full-gate subtracted sunset-dispersion lane",
...
def main() -> int:
    ...
    if not isinstance(major, dict) or major.get("major_result_id") != LANE_ID:
        raise SystemExit("subtracted sunset-dispersion lane major-result identity mismatch")
    ...
    register.setdefault("topic13_lane_sync", {})[
        "subtracted_sunset_dispersion_interface"
    ] = {
    ...
    partial.setdefault("lane_extensions", {})[
        "uet_o2_subtracted_sunset_dispersion_interface_lane"
    ] = {
        "major_result_id": LANE_ID,
    ...
    print(
        json.dumps(
            {
                "status": "PASS_TOPIC13_SUBTRACTED_SUNSET_DISPERSION_MAJOR_RESULT_SYNC",
                "major_result_id": LANE_ID,
