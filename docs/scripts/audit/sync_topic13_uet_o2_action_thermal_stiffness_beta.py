"""Synchronize the Topic 13 action-derived thermal stiffness beta lane."""
...
LANE_REL = "docs/core/07_artifacts/topic13/t13_uet_o2_action_thermal_stiffness_beta_audit.json"
DEPENDENCY_REL = "docs/core/07_artifacts/gates/uet_major_result_dependency_unlock_gate.json"
LANE_ID = "T13_UET_O2_ACTION_THERMAL_STIFFNESS_BETA_LANE"
ANCHOR_ID = "T13_THERMAL_RESPONSE_BETA_CONTRACT"
    ...
    record["evidence_artifacts"].append(
        {
            ...
            "sha256": full_hash,
            "summary": {
                "projection": "Topic 13 full-gate action-derived thermal stiffness beta lane",
...
def main() -> int:
    ...
    if not isinstance(major, dict) or major.get("major_result_id") != LANE_ID:
        raise SystemExit("action thermal stiffness beta lane identity mismatch")
    ...
    print(
        json.dumps(
            {
                "status": "PASS_TOPIC13_ACTION_THERMAL_STIFFNESS_BETA_MAJOR_RESULT_SYNC",
                "major_result_id": LANE_ID,
