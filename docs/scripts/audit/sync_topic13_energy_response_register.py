"""Add the named Phi_E energy-response result to the major-result register."""
...
def main() -> int:
    ...
    insert_at = next(
        (
            ...
            if item.get("major_result_id") == "T13_ALPHA_PHI_K_CONDITIONAL_DERIVATION"
        ),
        len(entries),
    )
