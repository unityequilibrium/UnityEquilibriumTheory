"""Synchronize the Topic 13 finite-temperature sunset SK/KMS lane record."""
...
LANE_REL = "docs/core/07_artifacts/topic13/t13_uet_o2_finite_temperature_sunset_sk_kms_audit.json"
DEPENDENCY_REL = "docs/core/07_artifacts/gates/uet_major_result_dependency_unlock_gate.json"
LANE_ID = "T13_UET_O2_FINITE_T_THREE_BODY_SUNSET_SK_KMS_LANE"
ANCHOR_ID = "T13_UET_O2_VACUUM_RETARDED_SUNSET_DISCONTINUITY_LANE"
    ...
    record["evidence_artifacts"].append(
        {
            ...
            "sha256": full_hash,
            "summary": {
                "projection": "Topic 13 full-gate finite-temperature sunset SK/KMS lane",
...
def main() -> int:
    ...
    if not isinstance(major, dict) or major.get("major_result_id") != LANE_ID:
        raise SystemExit("finite-temperature sunset SK/KMS lane major-result identity mismatch")
    ...
    register.setdefault("topic13_lane_sync", {})[
        "finite_temperature_three_body_sunset_sk_kms"
    ] = {
    ...
    partial.setdefault("lane_extensions", {})[
        "uet_o2_finite_t_three_body_sunset_sk_kms_lane"
    ] = {
        "major_result_id": LANE_ID,
    ...
    print(
        json.dumps(
            {
                "status": "PASS_TOPIC13_FINITE_T_SUNSET_SK_KMS_MAJOR_RESULT_SYNC",
                "major_result_id": LANE_ID,
