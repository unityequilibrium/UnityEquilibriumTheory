...
ROUTE_SPECS: tuple[dict[str, Any], ...] = (
    ...
    spec(
        ...
        {
            "source_identity_and_locator": "The Materials Cloud record, DOI, archive identity, and selected raw-entry locators are locked.",
            "raw_numeric_or_reproduction_payload": "The natural-graphite SpecificC rows are archived and re-read from the raw CSV.",
            "source_hash": "The archive members, source notebook, and package inputs are hash-verified.",
            "temperature_and_state": "Natural-graphite rows at 200 K and 300 K are present; exact Ding specimen equivalence remains open.",
            "holdout_and_fit_audit": "The audit excludes target fitting, alpha fitting, and Xie 2026 access.",
        },
        (
            "package_present",
            "calorine_package_present",
            "all_archived_entries_match_hash_and_size",
            ...
            "selected_rows_match_raw_source",
            "declared_conversion_factor_is_si_closed",
            "equilibrium_crosscheck_computed",
            "ding_response_contract_not_claimed",
            "mode_resolved_payload_not_claimed",
            "source_uncertainty_not_promoted",
            "target_curve_unused",
            "fit_unused",
            "alpha_fit_unused",
            "holdout_unconsumed",
        ...
        (),
        "COMPARATOR_REJECTED_CV_NO_DING_RESPONSE_OR_SOURCE_GRADE",
        (
            "SpecificC is a macroscopic C_v comparator, not a Ding mode-resolved C_src response contract",
            "source-grade uncertainty is explicitly absent from the QH-15 archive",
            "exact Ding TTG specimen, morphology, isotope/defect state, and response equivalence are not established",
        ),
        "Keep QH-15 as a natural-graphite C_v comparator; obtain the authorized Ding payload or a same-regime PBTE reproduction with source-grade uncertainty before acceptance.",
    ),
)
