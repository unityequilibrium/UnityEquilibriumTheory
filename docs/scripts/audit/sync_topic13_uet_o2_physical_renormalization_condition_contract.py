"""Synchronize the Topic 13 physical-renormalization condition contract."""
...
LANE_REL = "docs/core/07_artifacts/topic13/t13_uet_o2_physical_renormalization_condition_contract.json"
DEPENDENCY_REL = "docs/core/07_artifacts/gates/uet_major_result_dependency_unlock_gate.json"
LANE_ID = "T13_UET_O2_PHYSICAL_RENORMALIZATION_CONDITION_CONTRACT"
ANCHOR_ID = "T13_UET_O2_FINITE_T_SUNSET_RENORMALIZATION_IDENTIFIABILITY_NO_GO"
...
def lane_record(major: dict, full_hash: str) -> dict:
    ...
    record["evidence_artifacts"].append({
        ...
        "sha256": full_hash,
        "summary": {
            "projection": "Topic 13 full-gate physical-renormalization condition contract",
...
def main() -> int:
    ...
    if not isinstance(major, dict) or major.get("major_result_id") != LANE_ID:
        raise SystemExit("physical-renormalization condition contract identity mismatch")
    ...
    register.setdefault("topic13_lane_sync", {})["physical_renormalization_condition_contract"] = {
    ...
    partial.setdefault("lane_extensions", {})["physical_renormalization_condition_contract"] = {
        "major_result_id": LANE_ID,
    ...
    print(json.dumps({
        "status": "PASS_TOPIC13_PHYSICAL_RENORMALIZATION_CONDITION_CONTRACT_MAJOR_RESULT_SYNC",
        "major_result_id": LANE_ID,
