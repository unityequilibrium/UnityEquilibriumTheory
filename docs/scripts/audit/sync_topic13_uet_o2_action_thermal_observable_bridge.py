"""Synchronize the Topic 13 natural Phi-to-thermal bridge lane."""
...
LANE_REL = "docs/core/07_artifacts/topic13/t13_uet_o2_action_thermal_observable_bridge_audit.json"
DEPENDENCY_REL = "docs/core/07_artifacts/gates/uet_major_result_dependency_unlock_gate.json"
LANE_ID = "T13_UET_O2_ACTION_NATURAL_PHI_THERMAL_BRIDGE_LANE"
ANCHOR_ID = "T13_UET_O2_ACTION_THERMAL_STIFFNESS_BETA_LANE"
    ...
    record["evidence_artifacts"].append(
        {
            ...
            "sha256": full_hash,
            "summary": {
                "projection": "Topic 13 full-gate natural Phi-to-thermal bridge lane",
...
def main() -> int:
    ...
    if not isinstance(major, dict) or major.get("major_result_id") != LANE_ID:
        raise SystemExit("natural Phi-to-thermal bridge lane identity mismatch")
    ...
    register.setdefault("topic13_lane_sync", {})["action_natural_phi_thermal_bridge"] = {
    ...
    partial.setdefault("lane_extensions", {})["action_natural_phi_thermal_bridge"] = {
        "major_result_id": LANE_ID,
    ...
    print(
        json.dumps(
            {
                "status": "PASS_TOPIC13_ACTION_NATURAL_PHI_THERMAL_BRIDGE_MAJOR_RESULT_SYNC",
                "major_result_id": LANE_ID,
