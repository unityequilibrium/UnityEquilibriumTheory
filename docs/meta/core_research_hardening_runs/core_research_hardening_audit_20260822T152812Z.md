...
| 6 | `0.10_Fluid_Dynamics_Chaos` | Structured | B | manifested real dataset | present | FAIL present | - | - | Treat verifier failure as blocker; document cause and fix model or threshold. |
| 5 | `0.1_Galaxy_Rotation_Problem` | Structured | A | manifested real dataset | bootstrap/open | galaxy_history_comparison.json:BLOCKED | - | - | Harden bootstrap formula audit entries into reviewed formula/constant/unit records. |
...
| 4 | `0.25_Strategy_Power_Economics` | Structured | A | source-locked U.S. legacy panel; global complete-case panel blocked and superseded | present | PASS present | - | - | Upgrade DATA_MANIFEST.md with source, local path, unit convention, and benchmark role. |
...
| 0 | `0.13_Thermodynamic_Bridge` | Draft | B | manifested real dataset | present | 0_13_core_thermodynamic_constraint_gate.json:BLOCKED; 0_13_thermodynamic_bridge_verification.json:WARN; cattaneo_benchmark_artifact.json:SIMULATION_ONLY | - | - | Run topic verifier and harden remaining limitations. |
