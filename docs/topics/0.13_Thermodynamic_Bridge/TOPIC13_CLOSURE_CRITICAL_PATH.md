...
|---|---|---:|---|
| `T13_INPUT_DING_TTG_SOURCE` | `BLOCKED` | 2 | `False` |
| `T13_INPUT_BASE_PHI_SI_ALPHA_BETA` | `BLOCKED` | 3 | `False` |
| `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `BLOCKED` | 5 | `False` |

OPEN_SUBRESULTS:
| Subresult | Root input package | Closure level | Status |
|---|---|---|---|
| `accepted_numeric_csrc` | `T13_INPUT_DING_TTG_SOURCE` | `OPEN` | `OPEN` |
| `base_phi_si_anchor` | `T13_INPUT_BASE_PHI_SI_ALPHA_BETA` | `OPEN` | `OPEN` |
| `independent_alpha_record` | `T13_INPUT_BASE_PHI_SI_ALPHA_BETA` | `OPEN` | `OPEN` |
| `material_and_uncertainty_closure` | `T13_INPUT_DING_TTG_SOURCE` | `OPEN` | `OPEN` |
| `normalized_beta_si_map` | `T13_INPUT_BASE_PHI_SI_ALPHA_BETA` | `OPEN` | `OPEN` |
| `physical_entropy_production_mapping` | `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `OPEN` | `OPEN` |
| `physical_heat_flux_entropy_map` | `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `OPEN` | `OPEN` |
| `physical_sk_transport_match` | `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `OPEN` | `OPEN` |
| `physical_source_backed_eos` | `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `OPEN` | `OPEN` |
| `physical_uet_kubo_record` | `T13_INPUT_PHYSICAL_TRANSPORT_MATCH` | `OPEN` | `OPEN` |
