"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_action_thermal_stiffness_beta.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_action_thermal_stiffness_beta")
