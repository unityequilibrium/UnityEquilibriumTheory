"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_condensed_relative_flow_collision.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_condensed_relative_flow_collision")
