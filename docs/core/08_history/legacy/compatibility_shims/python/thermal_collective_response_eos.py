"""Compatibility shim for `docs/core/03_lanes/thermal/thermal_collective_response_eos.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.thermal_collective_response_eos")
