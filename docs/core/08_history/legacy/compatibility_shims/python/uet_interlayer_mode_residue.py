"""Compatibility shim for `docs/core/03_lanes/thermal/uet_interlayer_mode_residue.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_interlayer_mode_residue")
