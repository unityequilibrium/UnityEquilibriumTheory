"""Compatibility shim for `docs/core/03_lanes/thermal/thermal_sk_kms_entropy_contract.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.thermal_sk_kms_entropy_contract")
