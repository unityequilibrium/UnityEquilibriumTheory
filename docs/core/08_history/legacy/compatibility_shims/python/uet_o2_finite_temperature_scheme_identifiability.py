"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_finite_temperature_scheme_identifiability.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_finite_temperature_scheme_identifiability")
