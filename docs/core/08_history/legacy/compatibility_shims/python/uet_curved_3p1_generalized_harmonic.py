"""Compatibility shim for `docs/core/02_equations/covariant/uet_curved_3p1_generalized_harmonic.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.covariant.uet_curved_3p1_generalized_harmonic")
