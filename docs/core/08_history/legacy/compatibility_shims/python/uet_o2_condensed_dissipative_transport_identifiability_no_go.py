"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_condensed_dissipative_transport_identifiability_no_go.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_condensed_dissipative_transport_identifiability_no_go")
