"""Compatibility shim for `docs/core/03_lanes/thermal/uet_reciprocal_thermal_dynamics.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_reciprocal_thermal_dynamics")
