"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_nonlocal_sk_kms_memory_kernel.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_nonlocal_sk_kms_memory_kernel")
