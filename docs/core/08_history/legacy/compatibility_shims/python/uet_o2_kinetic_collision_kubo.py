"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_kinetic_collision_kubo.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_kinetic_collision_kubo")
