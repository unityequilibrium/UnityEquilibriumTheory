"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_one_loop_retarded_self_energy_no_go.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_one_loop_retarded_self_energy_no_go")
