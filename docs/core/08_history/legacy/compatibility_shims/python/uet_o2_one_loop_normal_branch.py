"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_one_loop_normal_branch.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_one_loop_normal_branch")
