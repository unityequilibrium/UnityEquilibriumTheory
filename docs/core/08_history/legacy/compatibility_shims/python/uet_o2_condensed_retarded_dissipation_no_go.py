"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_condensed_retarded_dissipation_no_go.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_condensed_retarded_dissipation_no_go")
