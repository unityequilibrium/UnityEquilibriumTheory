"""Compatibility shim for the canonical matter-space spatial implementation."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.matter_space.uet_spatial")
