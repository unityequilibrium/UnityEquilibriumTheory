"""Compatibility shim for `docs/core/03_lanes/thermal/uet_scalar_thermoelastic_response_bridge.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_scalar_thermoelastic_response_bridge")
