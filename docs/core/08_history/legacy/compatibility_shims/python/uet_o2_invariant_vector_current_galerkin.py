"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_invariant_vector_current_galerkin.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_invariant_vector_current_galerkin")
