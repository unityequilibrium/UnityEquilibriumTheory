"""Compatibility shim for `docs/core/03_lanes/thermal/uet_transport_coefficient_identifiability.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_transport_coefficient_identifiability")
