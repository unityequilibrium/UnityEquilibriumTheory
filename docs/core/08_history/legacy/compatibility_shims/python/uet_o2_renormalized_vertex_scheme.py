"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_renormalized_vertex_scheme.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_renormalized_vertex_scheme")
