"""Compatibility shim for the canonical legacy Noether diagnostics."""
...
if __name__ == "__main__":
    _run_canonical_as_script(
        "docs.core.02_equations.lorentz_noether.uet_noether"
    )
else:
    _forward_public_symbols(
        globals(), "docs.core.02_equations.lorentz_noether.uet_noether"
    )
