"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_formal_two_sector_thermodynamics.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_formal_two_sector_thermodynamics")
