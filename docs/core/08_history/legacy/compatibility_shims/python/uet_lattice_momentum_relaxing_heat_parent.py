"""Compatibility shim for `docs/core/03_lanes/thermal/uet_lattice_momentum_relaxing_heat_parent.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_lattice_momentum_relaxing_heat_parent")
