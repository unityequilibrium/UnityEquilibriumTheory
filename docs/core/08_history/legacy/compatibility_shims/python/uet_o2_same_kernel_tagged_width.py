"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_same_kernel_tagged_width.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_same_kernel_tagged_width")
