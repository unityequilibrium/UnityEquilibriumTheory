"""Compatibility shim for the canonical Topic 13 formal bridge witness."""
...
_forward_public_symbols(
    globals(), "docs.core.03_lanes.topic13_support.t13_formal_thermodynamic_bridge_integration"
)
