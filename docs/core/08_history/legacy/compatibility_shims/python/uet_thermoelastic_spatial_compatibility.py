"""Compatibility shim for `docs/core/03_lanes/thermal/uet_thermoelastic_spatial_compatibility.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_thermoelastic_spatial_compatibility")
