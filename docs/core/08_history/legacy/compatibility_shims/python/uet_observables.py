"""Compatibility shim for the legacy observable helpers."""
...
if __name__ == "__main__":
    _run_canonical_as_script("docs.core.03_lanes.review.uet_observables")
else:
    _forward_public_symbols(
        globals(), "docs.core.03_lanes.review.uet_observables"
    )
