"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_tree_level_charged_ward_vertex.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_tree_level_charged_ward_vertex")
