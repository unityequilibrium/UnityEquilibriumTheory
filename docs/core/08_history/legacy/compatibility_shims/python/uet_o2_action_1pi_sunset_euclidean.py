"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_action_1pi_sunset_euclidean.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_action_1pi_sunset_euclidean")
