"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_finite_channel_entropy_balance.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_finite_channel_entropy_balance")
