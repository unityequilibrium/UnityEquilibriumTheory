"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_regularized_continuum_heat_current.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_regularized_continuum_heat_current")
