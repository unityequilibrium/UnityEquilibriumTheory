"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_finite_temperature_sunset_vacuum_match.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_finite_temperature_sunset_vacuum_match")
