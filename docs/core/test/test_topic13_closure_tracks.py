...
def test_core_and_external_validation_tracks_are_separate() -> None:
    ...
    assert core["major_result_id"] == "T13_FULL_THERMODYNAMIC_BRIDGE_CORE_READY"
...
def test_track_split_does_not_promote_topic13_or_read_holdout() -> None:
    ...
    assert gate["core_result_status"] == "T13_FULL_THERMODYNAMIC_BRIDGE_CORE_READY"
    assert gate["closure_tracks"]["o2_he4_core_ready"]["status"] == "CLOSED_FOR_CORE"
