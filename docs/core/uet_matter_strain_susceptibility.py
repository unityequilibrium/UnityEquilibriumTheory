"""Compatibility shim for `docs/core/03_lanes/thermal/uet_matter_strain_susceptibility.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_matter_strain_susceptibility")
