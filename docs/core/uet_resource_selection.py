"""Compatibility shim for `docs/core/03_lanes/persistence/uet_resource_selection.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.persistence.uet_resource_selection")
