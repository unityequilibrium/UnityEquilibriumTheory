"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_sunset_dispersion_interface_verified.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_sunset_dispersion_interface_verified")
