"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_dressed_ra_charge_current_ladder.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_dressed_ra_charge_current_ladder")
