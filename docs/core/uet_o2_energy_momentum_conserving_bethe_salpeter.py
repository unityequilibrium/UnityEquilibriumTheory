"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_energy_momentum_conserving_bethe_salpeter.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_energy_momentum_conserving_bethe_salpeter")
