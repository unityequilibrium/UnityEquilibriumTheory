...
Generated at: 2026-09-15T02:17:00+00:00
Generator: docs/scripts/audit/plan_uet_core_physical_migration.py

## Current control state

- Files indexed: **1815**
- Files with a move target: **1119**
- Already canonical/protected: **696**
- Dirty sources held back: **22**
- Duplicate targets: **0**
...
| Wave | Files |
| :-- | --: |
| already_canonical | 696 |
| artifacts | 589 |
| data_tooling | 86 |
| equation_or_lane | 144 |
| proofs | 1 |
| review | 1 |
| tests | 298 |
