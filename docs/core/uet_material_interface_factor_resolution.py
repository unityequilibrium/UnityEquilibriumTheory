"""Compatibility shim for `docs/core/03_lanes/thermal/uet_material_interface_factor_resolution.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_material_interface_factor_resolution")
