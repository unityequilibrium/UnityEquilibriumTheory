"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_finite_temperature_declared_retarded_1pi_grid.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_finite_temperature_declared_retarded_1pi_grid")
