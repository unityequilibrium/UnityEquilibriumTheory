"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_continuum_collision_operator.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_continuum_collision_operator")
