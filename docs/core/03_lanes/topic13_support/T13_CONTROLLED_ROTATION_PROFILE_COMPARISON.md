...
WHAT_CHANGED: Controlled rotated-profile solver/tests and [all fits and summary](../../07_artifacts/topic13/t13_ued_rotated_position_audit.json). The frozen unrotated artifact remains unchanged.
