...
WHAT_CHANGED: Pooling provenance audit, three tests and [generated artifact](../../07_artifacts/topic13/t13_ued_cut_pooling_audit.json), with source/hash linkage to the earlier raw structure audit. No external notebook was executed or redistributed.
