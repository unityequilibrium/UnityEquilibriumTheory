"""Compatibility shim for `docs/core/03_lanes/thermal/uet_material_lattice_interface_contract.py`."""
...
_forward_public_symbols(globals(), "docs.core.03_lanes.thermal.uet_material_lattice_interface_contract")
