"""Compatibility shim for the retained legacy master-equation engine."""
...
if __name__ == "__main__":
    _run_canonical_as_script("docs.core.02_equations.matter_space.uet_master_equation")
else:
    _forward_public_symbols(globals(), "docs.core.02_equations.matter_space.uet_master_equation")
