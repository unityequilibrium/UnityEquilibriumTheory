...
RECONCILIATION = "docs/core/07_artifacts/topic13/t13_csrc_reconciliation_audit.json"
...
def test_csrc_reconciliation_is_projected_with_all_prior_waves() -> None:
    ...
    assert "docs/core/07_artifacts/topic13/t13_base_phi_si_reconciliation_audit.json" in evidence_paths
