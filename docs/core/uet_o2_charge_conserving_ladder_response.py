"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_charge_conserving_ladder_response.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_charge_conserving_ladder_response")
