"""Compatibility shim for `docs/core/02_equations/o2/uet_o2_heat_current_kubo_match.py`."""
...
_forward_public_symbols(globals(), "docs.core.02_equations.o2.uet_o2_heat_current_kubo_match")
